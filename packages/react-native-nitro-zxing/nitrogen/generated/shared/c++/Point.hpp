...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::camera::zxing::Point> final {
    static inline margelo::nitro::camera::zxing::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::camera::zxing::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::zxing::Point& arg) {
