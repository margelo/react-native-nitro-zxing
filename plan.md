...
- `.gitmodules` (root): `packages/react-native-nitro-zxing/cpp/zxing-core` → `https://github.com/zxing-cpp/zxing-cpp.git` @ `v3.1.1` (local tarball `~/Downloads/zxing-cpp-3.1.1` for reference only).
